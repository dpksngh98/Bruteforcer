...
def is_url(new_url):
	...
	# 1) Checking the status codes by passing the request
	# 2) Status codes are validated online
	# 3) Online validation can lead to increased time due to internet speed
	try:
